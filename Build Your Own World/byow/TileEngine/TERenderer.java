...
public class TERenderer {
     ...
     */
    public void initialize(int w, int h, int xOff, int yOff, Engine engine) {
        this.width = w;
        this.height = h;
        this.xOffset = xOff;
        this.yOffset = yOff;
        ...
        hudFont = new Font("Monaco", Font.BOLD, 20);
        this.engine = engine;
     ...
     * @param h height of the window in tiles.
     */
    public void initialize(int w, int h, Engine engine) {
        initialize(w, h, 0, 0, engine);
    }
    ...
    public void renderFrame(TETile[][] world) {
        ...
        int[] mousePos = getMouse();
        StdDraw.setPenColor(Color.WHITE);
        StdDraw.setFont(hudFont);
        StdDraw.textLeft(1, this.height - 1, engine.finalWorldFrame[mousePos[0]][mousePos[1]].description());
        StdDraw.show();
    }
    public int[] getMouse(){
