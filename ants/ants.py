    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if place.ant.can_contain(self):
                ...
                ant_to_be_contained = place.ant
                place.ant = self
                self.store_ant(ant_to_be_contained)
            else:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        count = 0
        splace = self.place
        while splace and not splace.is_hive:
            if splace.bees and (self.lower_bound <= count <= self.upper_bound):
                return random_bee(splace.bees)
            else:
                splace = splace.entrance
                count = count + 1
        return None
        # END Problem 3 and 4
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8a
        a = not self.ant_contained
        b = not other.is_container
        return a and b
        # END Problem 8a
...
# END Problem 12
    ...
    def action(self, gamestate):
        ...
        a = self.place.exit
        while a:
            if a.ant and a.ant.is_container and a.ant.ant_contained:
